...
public class ConexionBaseDeDatosAlibaba{
    private static Connection conexion;
    private static final String driver = "com.mysql.cj.jdbc.Driver";
    private static final String user = "root";
    private static final String password = "";
    private static final String url = "jdbc:mysql://localhost:3306/alibaba";
    public ConexionBaseDeDatosAlibaba(){
        conexion=null;
        try {
    ...
    public boolean realizarConsulta(String query){
        ConexionBaseDeDatosAlibaba cn=new ConexionBaseDeDatosAlibaba();
        ResultSet rs;
        Statement st;
        ...
        try{
            ...
            if(rs!=null){
                ...
                if(rs.next()){
                    ...
                    System.out.println("Se encontro el producto con el agente vendedor Alibaba");
