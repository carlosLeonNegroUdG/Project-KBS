...
public class ConexionBaseDeDatosAmazon{
    ...
    public Boolean realizarConsulta(String query){
        ConexionBaseDeDatosAmazon cn=new ConexionBaseDeDatosAmazon();
        ResultSet rs;
        Statement st;
        ...
        try{
            ...
            if(rs!=null){
                    if(rs.next()){
                        System.out.println("Se encontro el producto con el agente vendedor Amazon");
